...
WEIGHT_TITLE = 0.2
WEIGHT_SECTION_TITLE = 0.2
WEIGHT_SECTION_TEXT = 0.1
WEIGHT_SUBSECTION_TITLE = 0.2
WEIGHT_SUBSECTION_TEXT = 0.1
WEIGHT_SUBSUBSECTION_TITLE = 0.1
WEIGHT_SUBSUBSECTION_TEXT = 0.1
