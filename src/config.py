...
WEIGHT_TITLE = 0.0
WEIGHT_SECTION_TITLE = 0.0
WEIGHT_SECTION_TEXT = 0.0
WEIGHT_SUBSECTION_TITLE = 0.0
WEIGHT_SUBSECTION_TEXT = 0.0
WEIGHT_SUBSUBSECTION_TITLE = 0.0
WEIGHT_SUBSUBSECTION_TEXT = 0.0
